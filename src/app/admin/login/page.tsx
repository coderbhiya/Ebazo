      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-stone-800 bg-stone-900/90 p-8 shadow-2xl backdrop-blur-xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-stone-700 bg-stone-950 py-2.5 pl-10 pr-3 text-xs text-white placeholder-stone-500 focus:border-primary-500 focus:outline-none"
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary-500 py-3 text-xs font-extrabold text-white shadow-lg shadow-primary-950/30 hover:bg-primary-600 transition-all disabled:opacity-60"
          >
            {loading ? (
              <>
