  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-stone-50/60 py-20">
        ...
        <p className="text-xs font-semibold text-stone-500">Loading {fallbackTitle || 'page'}...</p>
      </div>
    );
  }
  ...
  if (!page) {
    return (
      <div className="min-h-[65vh] flex flex-col items-center justify-center bg-stone-50/60 px-4 py-20 text-center">
        ...
        <h1 className="text-2xl font-black text-stone-900">{fallbackTitle || 'Page Not Available'}</h1>
        <p className="mt-2 text-xs text-stone-600 max-w-sm">
          This policy content is currently being updated in the Admin CMS Studio.
        </p>
